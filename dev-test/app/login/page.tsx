...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
            <div
                className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-sm"
            >
                    ...
                    <form action="" className="flex flex-col space-y-5">
                        <div className="flex flex-col space-y-1">
                            ...
                            <input
                                ...
                                className={`${isValid ? "px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus: outline-none focus:ring-4 focus:ring-blue-200" : "px-4 py-2 transition duration-300 border border-red-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-red-200"}`}
